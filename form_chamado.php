...
<div class="content-wrapper">
  <div class="container-fluid" style="margin-top: 30px; ">
    <div class="d_flex" style="margin-left: 340px; margin-right: 340px;">
  ...
  <?php if (isset($_GET['id']) && $_GET['id'] != '') { ?>
    <div class="chamado">
      <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#registroHistorico"><i class="fas fa-edit"></i></button>
